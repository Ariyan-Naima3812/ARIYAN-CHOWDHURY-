...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "ARIYAN") || (event.body.toLowerCase() == "Ariyan Vai") || (event.body.toLowerCase() == "@𝐀𝐑𝐈𝐘𝐀𝐍\_\❶④❸ ;* :/ 3:)ㅤ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ ARIYAN ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100000033133005\nতার সাতে যোগা যোগ করবেন WhatsApp :-wa.me/+8801758011315", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: ARIYAN CHOWDHURY ❤️ হাই আমি মেসেন্জার ROBOT  আামার বস আরিয়ান আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is ARIYAN❤️ তাকে সবাই আরিয়ান নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@𝐀𝐑𝐈𝐘𝐀𝐍\_\❶④❸ ;* :/ 3:)ㅤ") || (event.body.toLowerCase() == "@𝐀𝐑𝐈𝐘𝐀𝐍\_\❶④❸ ;* :/ 3:)ㅤ ")) {
     return api.sendMessage("বস বিজি আছে কেউ মেনশন দিবানা 😠🤡⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Tahamina") || (event.body.toLowerCase() == "tarin")) {
  ...
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস উল্লাস এর বোনের নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Tarin") || (event.body.toLowerCase() == "Tahamina")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস আরিয়ান এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Nahid ") || (event.body.toLowerCase() == "নাহিদ")) {
     return api.sendMessage("🥰-নাহিদ🌺 আমার বস আরিয়ান বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>ARIYAN CHOWDHURY", threadID);
   };
